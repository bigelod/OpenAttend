Public Class AddFamily
    ...
    Private Sub AddFamily_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnContinue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnContinue.Click
        Try
            ...
            If bolException = False Then
                ...
                Keyboard.Close()
                MessageBox.Show("Please collect your family badge.", "Family created", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub SaveFamilyData()
        ...
        intCurrentFamily = FamiliesBindingSource.Count() 'Get a family number
    ...
    Private Sub AddFamily_MouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseClick
        Keyboard.Focus()
    End Sub
