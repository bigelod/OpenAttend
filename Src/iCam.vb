...
#End Region
    ...
    Private OutputHeight As Integer = 600 'Max height
    Private OutputWidth As Integer = 800 'Max width
    ...
    Public Function copyFrame(ByVal src As PictureBox, ByVal rect As RectangleF) As Bitmap
        ...
        Else
            ...
            Return Nothing 'Edit: this removes a warning from no value being returned
        End If
    End Function
